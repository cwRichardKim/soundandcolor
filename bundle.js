...
$(document).ready(() => {
    ...
    keyboard.addListener(() => heat_plot.updateHeatPlot(key_heats.getTotalHeats()));
});
...
var heat_data = [{ "name": "C", "val": 0 }, { "name": "C#", "val": 0 }, { "name": "D", "val": 0 }, { "name": "D#", "val": 0 }, { "name": "E", "val": 0 }, { "name": "F", "val": 0 }, { "name": "F#", "val": 0 }, { "name": "G", "val": 100 }, { "name": "G#", "val": 0 }, { "name": "A", "val": 0 }, { "name": "A#", "val": 0 }, { "name": "B", "val": 0 }];
...
let x_k = d3.scaleBand().range([0, width_k]).padding(0.1);
let y_k = d3.scaleLinear().range([height_k, 0]);

let svg_k = d3.select("#key-graph").append("svg").attr("width", width_k + margin_k.left + margin_k.right).attr("height", height_k + margin_k.top + margin_k.bottom).append("g").attr("transform", "translate(" + margin_k.left + "," + margin_k.top + ")");
function initialize() {
